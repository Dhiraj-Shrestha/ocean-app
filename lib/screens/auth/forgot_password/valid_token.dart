...
class ValidResetPasswordToken extends StatefulWidget {
  // ignore: prefer_const_constructors_in_immutables
  ValidResetPasswordToken({Key key}) : super(key: key);

  @override
  _ValidResetPasswordTokenState createState() =>
      _ValidResetPasswordTokenState();
}

class _ValidResetPasswordTokenState extends State<ValidResetPasswordToken> {
                  ...
                  child: Container(
                    child: Column(
                      children: const [
                        ...
                        Text('Enter the OTP code that were send in your mail.',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                color: Colors.grey,
  ...
  _validToken() async {
    ...
    var response = await CallApi().checkToken('/user-check-token', data);
